window.FlipBook = function() {
    ...
    function e(t, s) {
        ...
        this.options.canClose && (0 === this.options.initialActivePage && this.el.classList.add(this.classNames.atFrontCover), this.pages.item(0).classList.add(this.classNames.firstPage), this.pages.item(this.pages.length - 1).classList.add(this.classNames.lastPage)),
        this.init()
    }
    return "boolean" != typeof t.preserve3d && (t.preserve3d = !0), e.prototype.getActivePages = function() {
        ...
        if (1 & l && (l -= 1), s.canClose)
            0 === s.initialActivePage && this.pages.item(0).classList.add(i.isActive);
        else {
        ...
        o.forEach(t => t.addEventListener("click", () => this.turnPage("back"))),
        r.forEach(t => t.addEventListener("click", () => {
            this.turnPage("forward"),
            s.initialCall && clearInterval(c)
        })),
        ...
        o = [f, p],
        n.forEach(t => {
            t.classList.remove(a.isActive),
            t.classList.add(a.wasActive)
        }),
        u.forEach(t => {
